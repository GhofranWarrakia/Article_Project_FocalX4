				...
				<li><a class="slide-item" href="{{ url('/' . $page='home') }}">الصفحة الرئيسة </a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='writers') }}">ادارة الكتّاب</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							{{-- <li><a class="slide-item" href="{{ url('/' . $page='admin/role-requests') }}">مراجعة طلبات الترقية</a></li> --}}
                            <li><a class="slide-item" href="{{ route('admin.role.requests') }}">مراجعة طلبات الترقية</a></li>
						</ul>
					@endcan
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='role-request') }}">فورم تقديم الطلبات</a></li>
						</ul>
					</li>
