...
<ul class="side-menu">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li>
                    <a class="slide-item" href="{{ url('/' . $page='article') }}" onclick="toggleSubMenu(event)">المقالات</a>
                    <ul class="sub-menu">
                        <li><a class="slide-item" href="{{ url('/' . $page='home') }}">مقالات صحية</a></li>
                        <li><a class="slide-item" href="{{ url('/' . $page='home') }}">مقالات بيئية</a></li>
                        <li><a class="slide-item" href="{{ url('/' . $page='home') }}">مقالات علمية</a></li>
						<li><a class="slide-item" href="{{ url('/' . $page='home') }}">مقالات دينية</a></li>
						<li><a class="slide-item" href="{{ url('/' . $page='home') }}">مقالات ادبية</a></li>
                    </ul>
                </li>
                <li><a class="slide-item" href="{{ url('/' . $page='invoice') }}">الكتّاب</a></li>
                <li><a class="slide-item" href="{{ url('/' . $page='block') }}">المحظورين</a></li>
            </ul>
        </li>
    </ul>
