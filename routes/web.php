...
Route::get('/writers', [UserController::class, 'index'])->name('writers.index');
Route::post('/writers', [UserController::class, 'store'])->name('writers.store');
Route::patch('/writers/{id}', [UserController::class, 'update'])->name('writers.update');
Route::delete('/writers/{id}', [UserController::class, 'destroy'])->name('writers.destroy');
